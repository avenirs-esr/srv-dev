...
write_env_file "AVENIRS_GRAFANA_CONTAINER_PORT" "$AVENIRS_GRAFANA_CONTAINER_PORT" ">>" "$AVENIRS_PORTFOLIO_ENV_FILE"
write_env_file "AVENIRS_OPENSEARCH_CONTAINER_NAME" "$AVENIRS_OPENSEARCH_CONTAINER_NAME" ">>" "$AVENIRS_PORTFOLIO_ENV_FILE"
write_env_file "AVENIRS_OPENSEARCH_CONTAINER_PORT" "$AVENIRS_OPENSEARCH_CONTAINER_PORT" ">>" "$AVENIRS_PORTFOLIO_ENV_FILE"
write_env_file "AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_NAME" "$AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_NAME" ">>" "$AVENIRS_PORTFOLIO_ENV_FILE"
write_env_file "AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_PORT" "$AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_PORT" ">>" "$AVENIRS_PORTFOLIO_ENV_FILE"
...
echo "avenirs.back-office.base-url=http://avenirs-portfolio-back-office:10010/back-office" >> $AVENIRS_PORTFOLIO_API_SPRING_ENV_FILE;
[ "`hostname`" = "srv-dev-avenir" ] && swagger_root="srv-dev-avenir.srv-avenir.brgm.recia.net" || swagger_root="localhost"

...
echo "AVENIRS_PROMETHEUS_CONTAINER_NAME=$AVENIRS_PROMETHEUS_CONTAINER_NAME" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_PROMETHEUS_CONTAINER_PORT=$AVENIRS_PROMETHEUS_CONTAINER_PORT" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_GRAFANA_CONTAINER_NAME=$AVENIRS_GRAFANA_CONTAINER_NAME" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_GRAFANA_CONTAINER_PORT=$AVENIRS_GRAFANA_CONTAINER_PORT" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_OPENSEARCH_CONTAINER_NAME=$AVENIRS_OPENSEARCH_CONTAINER_NAME" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_OPENSEARCH_CONTAINER_PORT=$AVENIRS_OPENSEARCH_CONTAINER_PORT" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_NAME=$AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_NAME" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_PORT=$AVENIRS_OPENSEARCH_DASHBOARDS_CONTAINER_PORT" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "GF_SECURITY_ADMIN_USER=$GF_SECURITY_ADMIN_USER" >> $AVENIRS_PORTFOLIO_ENV_FILE
echo "GF_SECURITY_ADMIN_PASSWORD=$GF_SECURITY_ADMIN_PASSWORD" >> $AVENIRS_PORTFOLIO_ENV_FILE

...
AVENIRS_PORTFOLIO_SECURITY_REMOTE_BRANCH=remotes/origin/access-control-first-steps
AVENIRS_PORTFOLIO_SECURITY_LOCAL_BRANCH=access_control
...
AVENIRS_PORTFOLIO_SECURITY_OIDC_FILE=$AVENIRS_PORTFOLIO_SECURITY_OVERLAY_DIR/src/main/resources/oidc-settings.json.no-git

...
[ -z "$AVENIRS_OPENSEARCH_CONTAINER_NAME" ] && AVENIRS_OPENSEARCH_CONTAINER_NAME="${AVENIRS_PORTFOLIO_CONTAINER_PREFIX}opensearch-dashboards"
...
AVENIRS_PORTFOLIO_BACK_OFFICE_REPOSITORY_DIR=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-back-office
[ -z "$AVENIRS_PORTFOLIO_BACK_OFFICE_CONTAINER_NAME" ] && AVENIRS_PORTFOLIO_BACK_OFFICE_CONTAINER_NAME="${AVENIRS_PORTFOLIO_CONTAINER_PREFIX}back-office"

AVENIRS_PORTFOLIO_BACK_OFFICE_CONTAINER_PORT=10008

[ -z  "$AVENIRS_PORTFOLIO_BACK_OFFICE_OVERLAY_DIR" ] && AVENIRS_PORTFOLIO_BACK_OFFICE_OVERLAY_DIR=$AVENIRS_PORTFOLIO_OVERLAY_DIR/avenirs-portfolio-back-office/
AVENIRS_PORTFOLIO_BACK_OFFICE_OVERLAY_BASENAME=$AVENIRS_PORTFOLIO_OVERLAY_BASENAME/`basename $AVENIRS_PORTFOLIO_BACK_OFFICE_OVERLAY_DIR`


AVENIRS_PORTFOLIO_BACK_OFFICE_SPRING_ENV_FILE=$AVENIRS_PORTFOLIO_BACK_OFFICE_OVERLAY_DIR/src/main/resources/env.properties

# ---- avenirs-portfolio-interoperability
AVENIRS_PORTFOLIO_INTEROPERABILITY_REPOSITORY_DIR=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-interoperability
[ -z "$AVENIRS_PORTFOLIO_INTEROPERABILITY_CONTAINER_NAME" ] && AVENIRS_PORTFOLIO_INTEROPERABILITY_CONTAINER_NAME="${AVENIRS_PORTFOLIO_CONTAINER_PREFIX}interoperability"

AVENIRS_PORTFOLIO_INTEROPERABILITY_CONTAINER_PORT=10009

[ -z  "$AVENIRS_PORTFOLIO_INTEROPERABILITY_OVERLAY_DIR" ] && AVENIRS_PORTFOLIO_INTEROPERABILITY_OVERLAY_DIR=$AVENIRS_PORTFOLIO_OVERLAY_DIR/avenirs-portfolio-interoperability/
AVENIRS_PORTFOLIO_INTEROPERABILITY_OVERLAY_BASENAME=$AVENIRS_PORTFOLIO_OVERLAY_BASENAME/`basename $AVENIRS_PORTFOLIO_INTEROPERABILITY_OVERLAY_DIR`


AVENIRS_PORTFOLIO_INTEROPERABILITY_SPRING_ENV_FILE=$AVENIRS_PORTFOLIO_INTEROPERABILITY_OVERLAY_DIR/src/main/resources/env.properties
...
AVENIRS_PORTFOLIO_BACK_OFFICE_CLEAN_DB=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-back-office/src/main/resources/db/clean.sql
AVENIRS_PORTFOLIO_BACK_OFFICE_CLEAN_DB_CLEAR=$PGSQL_INIT_DIR/10_avenirs-back-office_clean.generated.sql

AVENIRS_PORTFOLIO_BACK_OFFICE_INIT_DB=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-back-office/src/main/resources/db/init-db.sql
AVENIRS_PORTFOLIO_BACK_OFFICE_INIT_DB_CLEAR=$PGSQL_INIT_DIR/11_avenirs-back-office_init-db.generated.sql

AVENIRS_PORTFOLIO_INTEROPERABILITY_CLEAN_DB=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-interoperability/src/main/resources/db/clean.sql
AVENIRS_PORTFOLIO_INTEROPERABILITY_CLEAN_DB_CLEAR=$PGSQL_INIT_DIR/10_avenirs-interoperability_clean.generated.sql

AVENIRS_PORTFOLIO_INTEROPERABILITY_INIT_DB=$AVENIRS_PORTFOLIO_SCRIPT_DIR/../avenirs-portfolio-interoperability/src/main/resources/db/init-db.sql
AVENIRS_PORTFOLIO_INTEROPERABILITY_INIT_DB_CLEAR=$PGSQL_INIT_DIR/11_avenirs-interoperability_init-db.generated.sql
...
[ -z "$AVENIRS_APISIX_INIT_CONTAINER_NAME" ] && AVENIRS_APISIX_INIT_CONTAINER_NAM="${AVENIRS_APISIX_CONTAINER_PREFIX}init"
...
APISIX_CONFIG_TEMPLATE=$APISIX_OVERLAY_DIR/example/apisix_conf/config.yaml.template
APISIX_UI_CONFIG_TEMPLATE=$APISIX_OVERLAY_DIR/example/dashboard_conf/conf.yaml.template
APISIX_GRAFANA_CONFIG_TEMPLATE=$APISIX_OVERLAY_DIR/example/grafana_conf/config/grafana.ini.template

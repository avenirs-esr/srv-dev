...
# their volumes are not created to avoid orphan directories.
...
# .env file generation
# postgres-primary-exporter, postgresql-secondary1/2 and adminer are temporarily
# disabled in docker-compose.yml: their container names/volumes are not generated.
...
GLOBAL_ENV_FILE=$SRV_DEV_SCRIPT_DIR/../../../.env
echo "POSTGRES_USER=$POSTGRES_USER" >> $GLOBAL_ENV_FILE
echo "POSTGRES_PASSWORD=$SEC_POSTGRES_PASSWORD" >> $GLOBAL_ENV_FILE

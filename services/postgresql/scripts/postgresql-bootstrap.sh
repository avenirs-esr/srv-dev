...
init_volumes "postgresql" $AVENIRS_POSTGRESQL_PRIMARY_VOLUME \
    ...
    $AVENIRS_POSTGRESQL_SECONDARY_CDC_VOLUME
...
echo "AVENIRS_POSTGRESQL_SECONDARY_CDC_CONTAINER_NAME=$AVENIRS_POSTGRESQL_SECONDARY_CDC_CONTAINER_NAME" >> $POSTGRESQL_ENV_FILE
...
echo "AVENIRS_POSTGRESQL_SECONDARY_CDC_VOLUME=$AVENIRS_POSTGRESQL_SECONDARY_CDC_VOLUME" >> $POSTGRESQL_ENV_FILE

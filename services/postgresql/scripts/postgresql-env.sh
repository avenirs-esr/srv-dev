...
[ -z  "$AVENIRS_POSTGRESQL_PRIMARY_EXPORTER_CONTAINER_NAME" ] && AVENIRS_POSTGRESQL_PRIMARY_EXPORTER_CONTAINER_NAME="${AVENIRS_CONTAINER_PREFIX}pgsql-primary-exporter"

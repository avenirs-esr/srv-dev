...
[ -z  "$AVENIRS_POSTGRESQL_SECONDARY_CDC_CONTAINER_NAME" ] && AVENIRS_POSTGRESQL_SECONDARY_CDC_CONTAINER_NAME="${AVENIRS_CONTAINER_PREFIX}pgsql-secondary-cdc"
...
[ -z "$AVENIRS_POSTGRESQL_SECONDARY_CDC_VOLUME" ] && AVENIRS_POSTGRESQL_SECONDARY_CDC_VOLUME=$AVENIRS_POSTGRESQL_VOLUMES_ROOT/secondary-cdc

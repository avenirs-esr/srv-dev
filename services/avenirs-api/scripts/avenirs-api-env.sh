...
# Git submodule.
AVENIRS_API_REPOSITORY_DIR=$AVENIRS_API_SCRIPT_DIR/../avenirs-api
AVENIRS_API_REMOTE_BRANCH=main
AVENIRS_API_LOCAL_BRANCH=local_main
AVENIRS_API_MAIN_BRANCH="main"
